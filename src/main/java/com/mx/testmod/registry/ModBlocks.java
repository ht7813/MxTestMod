...
public class ModBlocks {
    ...
    public static Block registerBlock(String name, Block block, ItemGroup... itemGroups) {
        ...
        return Registry.register(Registries.BLOCK, new Identifier(MxTestMod.MOD_ID, name), block);
    }

    public static void registerModBlocks() {
        MxTestMod.LOGGER.debug("Registering mod blocks for" + MxTestMod.MOD_ID);
    }
}